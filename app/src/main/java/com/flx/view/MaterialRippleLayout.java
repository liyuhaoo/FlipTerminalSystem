...
/**
 *
 * @description 适合于listView gridView的水波效果,使用说明：https://github.com/balysv/material-ripple
 * @date 2015-10-29下午2:02:57
 * @author liyuhaoo
 */
public class MaterialRippleLayout extends FrameLayout {
	...
	private boolean isInScrollingContainer() {
		...
		while (p != null && p instanceof ViewGroup) {
			// 源码中要添加对api版本的判断，否则java.lang.NoSuchMethodError:
